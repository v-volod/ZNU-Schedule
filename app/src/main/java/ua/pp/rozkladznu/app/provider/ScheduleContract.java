...
import static ua.pp.rozkladznu.app.provider.ScheduleDatabase.Tables;
...
public class ScheduleContract {
    ...
    public static final String CONTENT_AUTHORITY = "ua.pp.rozkladznu.app.provider.ScheduleProvider";
